...
-- raise notice '0: v_list_of_fields_to_insert_excl_effective%', v_list_of_fields_to_insert_excl_effective; 
...
-- raise notice '1 end first insert: p_search_fields%', p_search_fields;  
-- raise notice '1 end first insert: p_search_values%', p_search_values;  
-- raise notice '1 end first insert: p_effective%', p_effective;  
-- raise notice '1 end first insert: v_serial_key%', v_serial_key;  
-- raise notice '1 end first insert: v_keys_old%', v_keys_old;  
...
-- raise notice '2 new assertion with effective ended: v_list_of_fields_to_insert_excl_effective%', v_list_of_fields_to_insert_excl_effective;  
-- raise notice '2 new assertion with effective ended: p_asserted%', p_asserted;  
-- raise notice '2 new assertion with effective ended: p_effective%', p_effective;  
-- raise notice '2 new assertion with effective ended: v_serial_key%', v_serial_key;  
-- raise notice '2 new assertion with effective ended: v_keys_old%', v_keys_old;  
...
-- raise notice '3 new assertion with new effective: v_list_of_fields_to_insert_excl_effective%', v_list_of_fields_to_insert_excl_effective;  
-- raise notice '3 new assertion with new effective: p_asserted%', p_asserted;  
-- raise notice '3 new assertion with new effective: p_effective%', p_effective;  
-- raise notice '3 new assertion with new effective: v_serial_key%', v_serial_key;  
-- raise notice '3 new assertion with new effective: v_keys_old%', v_keys_old;  
...
-- raise notice '4 new values: p_list_of_fields%', p_list_of_fields;  
-- raise notice '4 new values: p_list_of_values%', p_list_of_values;   
-- raise notice '4 new values: v_serial_key%', v_serial_key;  
-- raise notice '4 new values: v_keys%', v_keys;  
